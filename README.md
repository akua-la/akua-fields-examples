...
```
tu checkout (este sitio, origen A)          servicio Akua Fields (origen B: akua-fields.vercel.app)
...
```
Los campos vienen del deploy en `config.js` (por default `akua-fields.vercel.app`),
...
> quedan en SAQ A. Ver el README de `akua-fields` para el detalle PCI.
